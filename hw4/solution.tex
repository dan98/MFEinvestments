...
\begin{itemize}
	...
	And with the given values, we find the following weights in the mean-variance portfolio: $$ w_0 = (0.7154,-0.4465,-0.2423)$$ The sum of the three weights equals $0.0266$, so the investor borrows this amount at the risk-free rate to invest in the risky portfolio. 
	...
	\item \textbf{depends on the previous answer ...}
